...
| **Data dictionary · Dictionnaire de données** | [`data-dictionary.md`](./data-dictionary.md) | [`data-dictionary.fr.md`](./data-dictionary.fr.md) | Référence champ par champ des 35 tables + 15 énumérations |
